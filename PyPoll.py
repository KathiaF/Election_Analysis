...
with open(file_to_load) as election_data:
        ...
        for row in file_reader:
                ...
                #unique names: If the candidate does not match any existing candidate...
...
#5.6 Save the results to our text file
...
with open(file_to_save, "w") as txt_file:
    ...
    for candidate_name in candidate_votes:
        ...
        #print(f"{candidate_name}: received {vote_percentage:.1f}%")
